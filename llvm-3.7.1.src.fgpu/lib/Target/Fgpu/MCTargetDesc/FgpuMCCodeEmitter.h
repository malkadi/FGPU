//===-- FgpuMCCodeEmitter.h - Convert Fgpu Code to Machine Code -----------===//
//
...
#ifndef FGPU_MC_CODE_EMITTER_H
#define FGPU_MC_CODE_EMITTER_H
...
class FgpuMCCodeEmitter : public MCCodeEmitter {
  ...
  void operator=(const FgpuMCCodeEmitter &) = delete;
