...
define void @xcorr(i32* nocapture readonly %in1, i32* nocapture readonly %in2, i32* nocapture %out) #1 {
  %1 = tail call i32 asm sideeffect "lid $0, $1", "=r,I,~{$1}"(i32 0) #3, !srcloc !23
  %2 = tail call i32 asm sideeffect "wgoff $0, $1", "=r,I,~{$1}"(i32 0) #3, !srcloc !24
  %3 = add nsw i32 %2, %1
  %4 = tail call i32 asm sideeffect "size $0, $1", "=r,I,~{$1}"(i32 0) #3, !srcloc !25
  br label %5

; <label>:5                                       ; preds = %5, %0
  %res.0 = phi i32 [ 0, %0 ], [ %12, %5 ]
  %i.0 = phi i32 [ 0, %0 ], [ %13, %5 ]
  %6 = getelementptr inbounds i32, i32* %in1, i32 %i.0
  %7 = load i32, i32* %6, align 4, !tbaa !26
  %8 = add nsw i32 %i.0, %3
  %9 = getelementptr inbounds i32, i32* %in2, i32 %8
  %10 = load i32, i32* %9, align 4, !tbaa !26
  %11 = mul nsw i32 %10, %7
  %12 = add nsw i32 %11, %res.0
...
; <label>:15                                      ; preds = %5
  ...
  store i32 %.lcssa, i32* %16, align 4, !tbaa !26
  ret void
}
...
define void @xcorr_improved(i32* nocapture readonly %in1, i32* nocapture readonly %in2, i32* nocapture %out) #1 {
  ...
  %3 = add nsw i32 %2, %1
  %4 = shl i32 %3, 2
  %5 = tail call i32 asm sideeffect "size $0, $1", "=r,I,~{$1}"(i32 0) #3, !srcloc !25
  %6 = shl i32 %5, 2
  br label %7

; <label>:7                                       ; preds = %7, %0
  %i.0 = phi i32 [ 0, %0 ], [ %30, %7 ]
  %res1.0 = phi i32 [ 0, %0 ], [ %14, %7 ]
  %res2.0 = phi i32 [ 0, %0 ], [ %19, %7 ]
  %res3.0 = phi i32 [ 0, %0 ], [ %24, %7 ]
  %res4.0 = phi i32 [ 0, %0 ], [ %29, %7 ]
  %8 = getelementptr inbounds i32, i32* %in1, i32 %i.0
  %9 = load i32, i32* %8, align 4, !tbaa !26
  %10 = add nsw i32 %i.0, %4
  %11 = getelementptr inbounds i32, i32* %in2, i32 %10
  %12 = load i32, i32* %11, align 4, !tbaa !26
  %13 = mul nsw i32 %12, %9
  %14 = add nsw i32 %13, %res1.0
  %15 = add nsw i32 %10, 1
  %16 = getelementptr inbounds i32, i32* %in2, i32 %15
  %17 = load i32, i32* %16, align 4, !tbaa !26
  %18 = mul nsw i32 %17, %9
  %19 = add nsw i32 %18, %res2.0
  %20 = add nsw i32 %10, 2
  %21 = getelementptr inbounds i32, i32* %in2, i32 %20
  %22 = load i32, i32* %21, align 4, !tbaa !26
  %23 = mul nsw i32 %22, %9
  %24 = add nsw i32 %23, %res3.0
  %25 = add nsw i32 %10, 3
  %26 = getelementptr inbounds i32, i32* %in2, i32 %25
  %27 = load i32, i32* %26, align 4, !tbaa !26
  %28 = mul nsw i32 %27, %9
  %29 = add nsw i32 %28, %res4.0
  %30 = add nuw nsw i32 %i.0, 1
  %31 = icmp eq i32 %30, %6
  br i1 %31, label %32, label %7

; <label>:32                                      ; preds = %7
  %.lcssa18 = phi i32 [ %29, %7 ]
  %.lcssa17 = phi i32 [ %24, %7 ]
  %.lcssa16 = phi i32 [ %19, %7 ]
  %.lcssa = phi i32 [ %14, %7 ]
  %33 = getelementptr inbounds i32, i32* %out, i32 %4
  store i32 %.lcssa, i32* %33, align 4, !tbaa !26
  %34 = or i32 %4, 1
  %35 = getelementptr inbounds i32, i32* %out, i32 %34
  store i32 %.lcssa16, i32* %35, align 4, !tbaa !26
  %36 = or i32 %4, 2
  %37 = getelementptr inbounds i32, i32* %out, i32 %36
  store i32 %.lcssa17, i32* %37, align 4, !tbaa !26
  %38 = or i32 %4, 3
  %39 = getelementptr inbounds i32, i32* %out, i32 %38
  store i32 %.lcssa18, i32* %39, align 4, !tbaa !26
  ret void
}
...
; <label>:5                                       ; preds = %5, %0
  %res.0 = phi i32 [ 0, %0 ], [ %14, %5 ]
  %i.0 = phi i32 [ 0, %0 ], [ %15, %5 ]
  %6 = getelementptr inbounds i16, i16* %in1, i32 %i.0
  %7 = load i16, i16* %6, align 2, !tbaa !30
  %8 = sext i16 %7 to i32
  %9 = add nsw i32 %i.0, %3
  %10 = getelementptr inbounds i16, i16* %in2, i32 %9
  %11 = load i16, i16* %10, align 2, !tbaa !30
  %12 = sext i16 %11 to i32
  %13 = mul nsw i32 %12, %8
  %14 = add nsw i32 %13, %res.0
...
; <label>:17                                      ; preds = %5
  ...
  store i16 %18, i16* %19, align 2, !tbaa !30
  ret void
}
...
; <label>:5                                       ; preds = %5, %0
  %res1.0 = phi i32 [ 0, %0 ], [ %22, %5 ]
  %res2.0 = phi i32 [ 0, %0 ], [ %31, %5 ]
  %i.0 = phi i32 [ 0, %0 ], [ %32, %5 ]
  %6 = getelementptr inbounds <2 x i16>, <2 x i16>* %in1, i32 %i.0
  %7 = load <2 x i16>, <2 x i16>* %6, align 4
  %8 = extractelement <2 x i16> %7, i32 0
  %9 = sext i16 %8 to i32
  %10 = add nsw i32 %i.0, %3
  %11 = getelementptr inbounds <2 x i16>, <2 x i16>* %in2, i32 %10
  %12 = load <2 x i16>, <2 x i16>* %11, align 4
  %13 = extractelement <2 x i16> %12, i32 0
  %14 = sext i16 %13 to i32
  %15 = mul nsw i32 %14, %9
  %16 = add nsw i32 %15, %res1.0
  %17 = extractelement <2 x i16> %7, i32 1
  ...
  %23 = mul nsw i32 %20, %9
  %24 = add nsw i32 %23, %res2.0
  %25 = add nsw i32 %10, 1
  %26 = getelementptr inbounds <2 x i16>, <2 x i16>* %in2, i32 %25
...
; <label>:34                                      ; preds = %5
  ...
  %36 = getelementptr inbounds <2 x i16>, <2 x i16>* %out, i32 %3
  %37 = insertelement <2 x i16> undef, i16 %35, i32 0
  %38 = trunc i32 %.lcssa6 to i16
  %39 = insertelement <2 x i16> %37, i16 %38, i32 1
  store <2 x i16> %39, <2 x i16>* %36, align 4
  ret void
}
...
; <label>:5                                       ; preds = %5, %0
  %res.0 = phi i32 [ 0, %0 ], [ %14, %5 ]
  %i.0 = phi i32 [ 0, %0 ], [ %15, %5 ]
  %6 = getelementptr inbounds i8, i8* %in1, i32 %i.0
  %7 = load i8, i8* %6, align 1, !tbaa !32
  %8 = sext i8 %7 to i32
  %9 = add nsw i32 %i.0, %3
  %10 = getelementptr inbounds i8, i8* %in2, i32 %9
  %11 = load i8, i8* %10, align 1, !tbaa !32
...
; <label>:5                                       ; preds = %5, %0
  %res1.0 = phi i32 [ 0, %0 ], [ %34, %5 ]
  %res2.0 = phi i32 [ 0, %0 ], [ %47, %5 ]
  %res3.0 = phi i32 [ 0, %0 ], [ %57, %5 ]
  %res4.0 = phi i32 [ 0, %0 ], [ %67, %5 ]
  %i.0 = phi i32 [ 0, %0 ], [ %68, %5 ]
  %6 = getelementptr inbounds <4 x i8>, <4 x i8>* %in1, i32 %i.0
  %7 = load <4 x i8>, <4 x i8>* %6, align 4
  %8 = extractelement <4 x i8> %7, i32 0
  %9 = sext i8 %8 to i32
  %10 = add nsw i32 %i.0, %3
  %11 = getelementptr inbounds <4 x i8>, <4 x i8>* %in2, i32 %10
  %12 = load <4 x i8>, <4 x i8>* %11, align 4
  %13 = extractelement <4 x i8> %12, i32 0
  %14 = sext i8 %13 to i32
  %15 = mul nsw i32 %14, %9
  %16 = add nsw i32 %15, %res1.0
  %17 = extractelement <4 x i8> %7, i32 1
  %18 = sext i8 %17 to i32
  %19 = extractelement <4 x i8> %12, i32 1
  %20 = sext i8 %19 to i32
  %21 = mul nsw i32 %20, %18
  %22 = add nsw i32 %16, %21
  %23 = extractelement <4 x i8> %7, i32 2
  %24 = sext i8 %23 to i32
  %25 = extractelement <4 x i8> %12, i32 2
  %26 = sext i8 %25 to i32
  %27 = mul nsw i32 %26, %24
  %28 = add nsw i32 %22, %27
  %29 = extractelement <4 x i8> %7, i32 3
  ...
  %35 = mul nsw i32 %20, %9
  %36 = add nsw i32 %35, %res2.0
  %37 = mul nsw i32 %26, %18
  %38 = add nsw i32 %36, %37
  %39 = mul nsw i32 %32, %24
  %40 = add nsw i32 %38, %39
  %41 = add nsw i32 %10, 1
  %42 = getelementptr inbounds <4 x i8>, <4 x i8>* %in2, i32 %41
  ...
  %48 = mul nsw i32 %26, %9
  %49 = add nsw i32 %48, %res3.0
  %50 = mul nsw i32 %32, %18
  %51 = add nsw i32 %49, %50
  %52 = mul nsw i32 %45, %24
  ...
  %58 = mul nsw i32 %32, %9
  %59 = add nsw i32 %58, %res4.0
  %60 = mul nsw i32 %45, %18
  %61 = add nsw i32 %59, %60
  %62 = mul nsw i32 %55, %24
...
; <label>:5                                       ; preds = %5, %0
  ...
  %10 = load float, float* %9, align 4, !tbaa !33
  %11 = fmul float %7, %10
...
; <label>:15                                      ; preds = %5
  ...
  store float %.lcssa, float* %16, align 4, !tbaa !33
  ret void
}
...
attributes #0 = { nounwind readnone "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="mips32r2" "target-features"="+mips32r2,+soft-float" "unsafe-fp-math"="false" "use-soft-float"="true" }
attributes #1 = { nounwind "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="mips32r2" "target-features"="+mips32r2,+soft-float" "unsafe-fp-math"="false" "use-soft-float"="true" }
