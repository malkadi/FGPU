...
define void @butterfly(<2 x float>* nocapture %in, i32 signext %iter, <2 x float>* nocapture readonly %twiddle) #1 {
  ...
  %30 = shufflevector <2 x float> %28, <2 x float> %23, <2 x i32> <i32 0, i32 2>
  %31 = insertelement <2 x float> undef, float %24, i32 0
  %32 = bitcast float %29 to i32
  %33 = xor i32 %32, -2147483648
  %34 = bitcast i32 %33 to float
  %35 = insertelement <2 x float> %31, float %34, i32 1
  %36 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %20, <2 x float> %23, <2 x float> %17)
  %37 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %30, <2 x float> %36)
  %38 = extractelement <2 x float> %19, i32 0
  ...
  %44 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %43, <2 x float> %23, <2 x float> %17)
  %45 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %21, <2 x float> %35, <2 x float> %44)
  store <2 x float> %37, <2 x float>* %16, align 8, !tbaa !10
  store <2 x float> %45, <2 x float>* %18, align 8, !tbaa !10
  ret void
}
