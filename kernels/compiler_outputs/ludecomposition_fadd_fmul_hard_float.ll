...
define void @ludecomposition_pass_fadd_fmul_hard_float(float* nocapture %mat, float* nocapture %L, i32 signext %size, i32 signext %k) #1 {
entry:
...
!0 = !{void (float*, float*, i32, i32)* @ludecomposition_pass_fadd_fmul_hard_float, !1, !2, !3, !4, !5}
